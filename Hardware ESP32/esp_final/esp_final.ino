...
// Server URLs
const char* captureServer = "http://10.1.7.193:5000/capture";   // Raspberry Pi's server for image capture
const char* stateServer = "http://10.1.7.64:5000/update";       // Server for sending switch state updates
